 ...
 * @author João
 */
public class opções extends javax.swing.JDialog {

    /**
     * Creates new form opções
     */
    public opções(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                opções dialog = new opções(new javax.swing.JFrame(), true);
